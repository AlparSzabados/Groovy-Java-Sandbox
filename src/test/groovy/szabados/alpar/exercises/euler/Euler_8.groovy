...
class Euler_8 {
    ...
    public void shouldResolveProblem8() {
        ...
        assert greatestProductOfAdjacentNumbers(13, _1000_DIGIT_NUMBER) == 23_514_624_000
    }
    ...
    private static List<Integer> digits(String num) {
        num.split('').collect { s -> Character.digit(s.charAt(0), 10) }
    }

    private static String _1000_DIGIT_NUMBER =
